...
| Type | Image | Notes |
| ---- | ----- | ----- |
| dqd | ghcr.io/ctrsploit/buildkit-v0.21.0-rc1:latest | points to `v0.1.0` |
| dqd | ghcr.io/ctrsploit/buildkit-v0.21.0-rc1:v0.1.0 | migrate from docker_archive |
| dqd | ssst0n3/docker_archive:buildkit-v0.21.0-rc1_v0.1.0 | - |
| ctr | ghcr.io/ctrsploit/buildkit-v0.21.0-rc1:ctr_v0.1.0 | - |
| ctr | ssst0n3/docker_archive:ctr_buildkit-v0.21.0-rc1_v0.1.0 | - |
...
```shell
$ dqd up buildkit/v0.21.0-rc1
$ ssh dqd-buildkit-v0.21.0-rc1
```
...
```shell
root@buildkit-0-21-0-rc1:~# cat <<EOF >Dockerfile
FROM ubuntu
RUN echo 1
EOF
root@buildkit-0-21-0-rc1:~# buildctl build --frontend=dockerfile.v0 --local context=. --local dockerfile=. --progress=plain
...
#4 sha256:6f5c5aa4e145204b113f983c003ff8ad6489394294ef95ec030bc94e3daded54 6.29MB / 41.55MB 1.7s
#4 sha256:6f5c5aa4e145204b113f983c003ff8ad6489394294ef95ec030bc94e3daded54 8.39MB / 41.55MB 1.8s
#4 sha256:6f5c5aa4e145204b113f983c003ff8ad6489394294ef95ec030bc94e3daded54 11.53MB / 41.55MB 2.1s
#4 sha256:6f5c5aa4e145204b113f983c003ff8ad6489394294ef95ec030bc94e3daded54 13.63MB / 41.55MB 2.3s
...
#4 sha256:6f5c5aa4e145204b113f983c003ff8ad6489394294ef95ec030bc94e3daded54 29.36MB / 41.55MB 3.6s
...
#4 sha256:6f5c5aa4e145204b113f983c003ff8ad6489394294ef95ec030bc94e3daded54 35.65MB / 41.55MB 4.2s
#4 sha256:6f5c5aa4e145204b113f983c003ff8ad6489394294ef95ec030bc94e3daded54 37.75MB / 41.55MB 4.4s
#4 sha256:6f5c5aa4e145204b113f983c003ff8ad6489394294ef95ec030bc94e3daded54 39.85MB / 41.55MB 4.5s
#4 sha256:6f5c5aa4e145204b113f983c003ff8ad6489394294ef95ec030bc94e3daded54 41.55MB / 41.55MB 5.1s done
...
```shell
root@buildkit-0-21-0-rc1:~# buildkitd --version
buildkitd github.com/moby/buildkit v0.21.0-rc1 40a5c2d56d8b064f98718f29dd2fd7d5940d7b1c
root@buildkit-0-21-0-rc1:~# runc --version
runc version 1.2.6
commit: v1.2.6-0-ge89a2992
spec: 1.2.0
go: go1.23.7
libseccomp: 2.5.5
root@buildkit-0-21-0-rc1:~# cat /etc/os-release
...
LOGO=ubuntu-logo
root@buildkit-0-21-0-rc1:~# uname -a
Linux buildkit-0-21-0-rc1 6.8.0-117-generic #117-Ubuntu SMP PREEMPT_DYNAMIC Tue May  5 19:26:24 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
```

## build

```shell
make all ENV=buildkit/v0.21.0-rc1
```

for developers:

```dockerfile
FROM ghcr.io/ctrsploit/buildkit-v0.21.0-rc1:ctr_v0.1.0
```
