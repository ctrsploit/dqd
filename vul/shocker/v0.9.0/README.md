...
* dqd: 
    * ghcr.io/ctrsploit/shocker-v0.9.0 -> ghcr.io/ctrsploit/shocker-v0.9.0:v0.1.0
    * ghcr.io/ctrsploit/shocker-v0.9.0:v0.1.0
* ctr: 
    * ghcr.io/ctrsploit/shocker-v0.9.0:ctr_v0.1.0 -> ghcr.io/ctrsploit/shocker-v0.9.0:ctr_v0.1.0:v0.1.0
    * ghcr.io/ctrsploit/shocker-v0.9.0:ctr_v0.1.0:v0.1.0
...
```shell
make all ENV=vul/shocker/shocker-v0.9.0
```

for developers:

```dockerfile
FROM ghcr.io/ctrsploit/shocker-v0.9.0:ctr_v0.1.0:v0.1.0
```
