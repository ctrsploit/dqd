...
| Type | Image | Notes |
| ---- | ----- | ----- |
| dqd | ghcr.io/ctrsploit/harbor-v2.15.2:latest | points to `v0.1.2` |
| dqd | ghcr.io/ctrsploit/harbor-v2.15.2:v0.1.2 | official default Harbor v2.15.2 deployment |
| ctr | ghcr.io/ctrsploit/harbor-v2.15.2:ctr_v0.1.2 | base image for `vul/harbor-*` envs |
