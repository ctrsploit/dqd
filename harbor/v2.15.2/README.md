...
| dqd | ghcr.io/ctrsploit/harbor-v2.15.2:v0.1.13 | superseded: runner AppArmor is fully locked down (sudo .complain write → Permission denied, apparmor_parser not available); pivoted to chmod 644 /etc/shadow inside containers so unix_chkpwd never needs dac_override |
