...
install_calico_network() {
  ...
  # https://docs.tigera.io/archive/v3.25/getting-started/kubernetes/requirements#kubernetes-requirements
  # https://docs.tigera.io/archive/v3.25/getting-started/kubernetes/quickstart#install-calico
