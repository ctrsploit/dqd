# kubernetes v1.36.2 with containerd v2.3.0

| type | image | note |
| ---- | ----- | ---- |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.36.2_containerd-v2.3.0_init:latest | point to v0.1.0 |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.36.2_containerd-v2.3.0_init:v0.1.0 | - |
| ctr | ghcr.io/ctrsploit/kubernetes-v1.36.2_containerd-v2.3.0_init:ctr_v0.1.0 | - |
...
```shell
$ dqd up kubernetes/v1.36.2/containerd/v2.3.0/init
$ ssh dqd-kubernetes-v1.36.2_containerd-v2.3.0_init
```

Fallback without dqd CLI or SSH config:

```shell
$ cd kubernetes/v1.36.2/containerd/v2.3.0/init
...
kube-system   coredns-589f44dc88-bx4pz                                     0/1     Pending   0             21m
kube-system   coredns-589f44dc88-gxg5s                                     0/1     Pending   0             21m
kube-system   etcd-kubernetes-1-36-2-containerd-2-3-0                      1/1     Running   1 (85s ago)   21m
kube-system   kube-apiserver-kubernetes-1-36-2-containerd-2-3-0            1/1     Running   1 (85s ago)   21m
kube-system   kube-controller-manager-kubernetes-1-36-2-containerd-2-3-0   1/1     Running   1 (85s ago)   21m
kube-system   kube-proxy-d6jcb                                             1/1     Running   1 (85s ago)   21m
kube-system   kube-scheduler-kubernetes-1-36-2-containerd-2-3-0            1/1     Running   1 (85s ago)   21m
```
...
```shell
make all ENV=kubernetes/v1.36.2/containerd/v2.3.0/init
```
...
FROM ghcr.io/ctrsploit/kubernetes-v1.36.2_containerd-v2.3.0_init:ctr_v0.1.0
...
...
RUN --mount=type=cache,id=kubernetes-v1.36.2-containerd-v2.3.0-snapshots,target=/trick \
    cp -a /var/lib/containerd/io.containerd.snapshotter.v1.overlayfs/* /trick/
# kubeadm init under ext4 fs
RUN --mount=type=cache,id=kubernetes-v1.36.2-containerd-v2.3.0-snapshots,target=/var/lib/containerd/io.containerd.snapshotter.v1.overlayfs \
