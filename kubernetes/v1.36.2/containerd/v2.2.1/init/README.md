# kubernetes v1.36.2 with containerd v2.2.1

| type | image | note |
| ---- | ----- | ---- |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.36.2_containerd-v2.2.1_init:latest | point to v0.1.0 |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.36.2_containerd-v2.2.1_init:v0.1.0 | - |
| ctr | ghcr.io/ctrsploit/kubernetes-v1.36.2_containerd-v2.2.1_init:ctr_v0.1.0 | - |
...
```shell
$ dqd up kubernetes/v1.36.2/containerd/v2.2.1/init
$ ssh dqd-kubernetes-v1.36.2_containerd-v2.2.1_init
```

Fallback without dqd CLI or SSH config:

```shell
$ cd kubernetes/v1.36.2/containerd/v2.2.1/init
...
```shell
root@kubernetes-1-36-2-containerd-2-2-1:~# helm version
<!-- VERIFY -->
root@kubernetes-1-36-2-containerd-2-2-1:~# kubectl version
<!-- VERIFY -->
root@kubernetes-1-36-2-containerd-2-2-1:~# containerd --version
<!-- VERIFY -->
root@kubernetes-1-36-2-containerd-2-2-1:~# runc --version
<!-- VERIFY -->
root@kubernetes-1-36-2-containerd-2-2-1:~# cat /etc/os-release 
<!-- VERIFY -->
root@kubernetes-1-36-2-containerd-2-2-1:~# uname -a
<!-- VERIFY -->
```
...
```shell
make all ENV=kubernetes/v1.36.2/containerd/v2.2.1/init
```
...
FROM ghcr.io/ctrsploit/kubernetes-v1.36.2_containerd-v2.2.1_init:ctr_v0.1.0
...
...
RUN --mount=type=cache,id=kubernetes-v1.36.2-containerd-v2.2.1-snapshots,target=/trick \
    cp -a /var/lib/containerd/io.containerd.snapshotter.v1.overlayfs/* /trick/
# kubeadm init under ext4 fs
RUN --mount=type=cache,id=kubernetes-v1.36.2-containerd-v2.2.1-snapshots,target=/var/lib/containerd/io.containerd.snapshotter.v1.overlayfs \
