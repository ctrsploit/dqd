# kubernetes v1.35.1 with containerd v2.2.1

| type | image | note |
| ---- | ----- | ---- |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.35.1_containerd-v2.2.1_init:latest | point to v0.1.0 |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.35.1_containerd-v2.2.1_init:v0.1.0 | - |
| ctr | ghcr.io/ctrsploit/kubernetes-v1.35.1_containerd-v2.2.1_init:ctr_v0.1.0 | - |
...
```shell
$ dqd up kubernetes/v1.35.1/containerd/v2.2.1/init
...
```shell
$ cd kubernetes/v1.35.1/containerd/v2.2.1/init
...
kube-system   coredns-7d764666f9-4pdss                                     0/1     Pending   0              12m
kube-system   coredns-7d764666f9-msknr                                     0/1     Pending   0              12m
kube-system   etcd-kubernetes-1-35-1-containerd-2-2-1                      1/1     Running   1 (106s ago)   12m
kube-system   kube-apiserver-kubernetes-1-35-1-containerd-2-2-1            1/1     Running   1 (106s ago)   12m
kube-system   kube-controller-manager-kubernetes-1-35-1-containerd-2-2-1   1/1     Running   1 (106s ago)   12m
kube-system   kube-proxy-9r6g8                                             1/1     Running   1 (106s ago)   12m
kube-system   kube-scheduler-kubernetes-1-35-1-containerd-2-2-1            1/1     Running   1 (106s ago)   12m
```
...
```shell
make all ENV=kubernetes/v1.35.1/containerd/v2.2.1/init
```
...
FROM ghcr.io/ctrsploit/kubernetes-v1.35.1_containerd-v2.2.1_init:ctr_v0.1.0
...
...
RUN --mount=type=cache,id=kubernetes-v1.35.1_containerd-v2.2.1-snapshots,target=/trick \
    cp -a /var/lib/containerd/io.containerd.snapshotter.v1.overlayfs/* /trick/
# kubeadm init under ext4 fs
RUN --mount=type=cache,id=kubernetes-v1.35.1_containerd-v2.2.1-snapshots,target=/var/lib/containerd/io.containerd.snapshotter.v1.overlayfs \
