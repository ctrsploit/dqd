...
install_calico_network() {
  ...
  # https://docs.tigera.io/archive/v3.26/getting-started/kubernetes/requirements#kubernetes-requirements
  # https://docs.tigera.io/archive/v3.26/getting-started/kubernetes/quickstart#install-calico
  kubectl create -f https://raw.githubusercontent.com/projectcalico/calico/v3.26.5/manifests/tigera-operator.yaml >>/dev/kmsg 2>&1
  kubectl create -f https://raw.githubusercontent.com/projectcalico/calico/v3.26.5/manifests/custom-resources.yaml >>/dev/kmsg 2>&1
