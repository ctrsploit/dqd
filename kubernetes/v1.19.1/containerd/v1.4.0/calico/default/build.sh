...
NETWORK_NAME="dqd-k8s-1191-calico-buildx"
NETWORK_SUBNET="10.0.2.0/24"
NETWORK_IP_RANGE="10.0.2.16/28"
NETWORK_GATEWAY="10.0.2.1"
BUILDER_NAME="dqd-k8s-1191-calico-builder"
...
# what buildx-stable-1 resolved to when v1.19.1 init built successfully.
...
require_cgroup_v1() {
    ...
    if [[ "${fs_type}" != "tmpfs" ]]; then
        echo "Error: Kubernetes v1.19.1 kubelet requires cgroup v1; /sys/fs/cgroup is ${fs_type}." >&2
