...
install_calico_network() {
  ...
  # https://docs.tigera.io/archive/v3.22/getting-started/kubernetes/requirements#supported-versions
  # https://docs.tigera.io/archive/v3.22/getting-started/kubernetes/quickstart#install-calico
  kubectl create -f https://docs.projectcalico.org/archive/v3.22/manifests/tigera-operator.yaml >>/dev/kmsg 2>&1
  kubectl create -f https://docs.projectcalico.org/archive/v3.22/manifests/custom-resources.yaml >>/dev/kmsg 2>&1
