...
NETWORK_NAME="dqd-k8s-1220-calico-buildx"
NETWORK_SUBNET="10.0.2.0/24"
NETWORK_IP_RANGE="10.0.2.16/28"
NETWORK_GATEWAY="10.0.2.1"
BUILDER_NAME="dqd-k8s-1220-calico-builder"
...
require_cgroup_v1() {
    ...
    if [[ "${fs_type}" != "tmpfs" ]]; then
        echo "Error: Kubernetes v1.22.0 kubelet requires cgroup v1; /sys/fs/cgroup is ${fs_type}." >&2
