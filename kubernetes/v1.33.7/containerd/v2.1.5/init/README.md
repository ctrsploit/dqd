# kubernetes v1.33.7 with containerd v2.1.5

| type | image | note |
| ---- | ----- | ---- |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.33.7_containerd-v2.1.5_init:latest | point to v0.1.0 |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.33.7_containerd-v2.1.5_init:v0.1.0 | migrate from docker_archive |
| dqd | ssst0n3/docker_archive:kubernetes-v1.33.7_v0.1.0 | source |
| ctr | ghcr.io/ctrsploit/kubernetes-v1.33.7_containerd-v2.1.5_init:ctr_v0.1.0 | - |
| ctr | ssst0n3/docker_archive:ctr_kubernetes-v1.33.7_v0.1.0 | source |
...
```shell
$ dqd up kubernetes/v1.33.7/containerd/v2.1.5/init
$ ssh dqd-kubernetes-v1.33.7_containerd-v2.1.5_init
```

Fallback without dqd CLI or SSH config:

```shell
$ cd kubernetes/v1.33.7/containerd/v2.1.5/init
...
```shell
make all ENV=kubernetes/v1.33.7/containerd/v2.1.5/init
```
...
RUN --mount=type=cache,id=kubernetes-v1.33.7_containerd-v2.1.5-snapshots,target=/var/lib/containerd/io.containerd.snapshotter.v1.overlayfs \
