...
| type | image | note |
| ---- | ----- | ---- |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.32.4_containerd-v2.0.4_init:latest | point to v0.1.0 |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.32.4_containerd-v2.0.4_init:v0.1.0 | migrate from docker_archive |
| dqd | ssst0n3/docker_archive:kubernetes-v1.32.4_containerd-v2.0.4_v0.1.0 | source |
| ctr | ghcr.io/ctrsploit/kubernetes-v1.32.4_containerd-v2.0.4_init:ctr_v0.1.0 | - |
| ctr | ssst0n3/docker_archive:ctr_kubernetes-v1.32.4_containerd-v2.0.4_v0.1.0 | source |
...
```shell
$ dqd up kubernetes/v1.32.4/containerd/v2.0.4/init
$ ssh dqd-kubernetes-v1.32.4_containerd-v2.0.4_init
```

Fallback without dqd CLI or SSH config:

```shell
$ cd kubernetes/v1.32.4/containerd/v2.0.4/init
...
kube-system   coredns-668d6bf9bc-plj7l                                     0/1     Pending   0             20m
kube-system   coredns-668d6bf9bc-psmlb                                     0/1     Pending   0             20m
kube-system   etcd-kubernetes-1-32-4-containerd-2-0-4                      1/1     Running   1 (52s ago)   20m
kube-system   kube-apiserver-kubernetes-1-32-4-containerd-2-0-4            1/1     Running   1 (52s ago)   20m
kube-system   kube-controller-manager-kubernetes-1-32-4-containerd-2-0-4   1/1     Running   1 (52s ago)   20m
kube-system   kube-proxy-n85ch                                             1/1     Running   1 (52s ago)   20m
kube-system   kube-scheduler-kubernetes-1-32-4-containerd-2-0-4            1/1     Running   1 (52s ago)   20m
```
...
```shell
make all ENV=kubernetes/v1.32.4/containerd/v2.0.4/init
```
...
FROM ghcr.io/ctrsploit/kubernetes-v1.32.4_containerd-v2.0.4_init:ctr_v0.1.0
...
