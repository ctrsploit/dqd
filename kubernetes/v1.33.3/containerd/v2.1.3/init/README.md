# kubernetes v1.33.3 with containerd v2.1.3

| type | image | note |
| ---- | ----- | ---- |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.33.3_containerd-v2.1.3_init:latest | point to v0.1.0 |
| dqd | ghcr.io/ctrsploit/kubernetes-v1.33.3_containerd-v2.1.3_init:v0.1.0 | migrate from docker_archive |
| dqd | ssst0n3/docker_archive:kubernetes-v1.33.3_containerd-v2.1.3_v0.1.0 | source |
| ctr | ghcr.io/ctrsploit/kubernetes-v1.33.3_containerd-v2.1.3_init:ctr_v0.1.0 | - |
| ctr | ssst0n3/docker_archive:ctr_kubernetes-v1.33.3_containerd-v2.1.3_v0.1.0 | source |
...
```shell
$ dqd up kubernetes/v1.33.3/containerd/v2.1.3/init
$ ssh dqd-kubernetes-v1.33.3_containerd-v2.1.3_init
```

Fallback without dqd CLI or SSH config:

```shell
$ cd kubernetes/v1.33.3/containerd/v2.1.3/init
...
kube-system   coredns-674b8bbfcf-6dsw5                                     0/1     Pending   0              12m
kube-system   coredns-674b8bbfcf-tjk5x                                     0/1     Pending   0              12m
kube-system   etcd-kubernetes-1-33-3-containerd-2-1-3                      1/1     Running   1 (115s ago)   12m
kube-system   kube-apiserver-kubernetes-1-33-3-containerd-2-1-3            1/1     Running   1 (115s ago)   12m
kube-system   kube-controller-manager-kubernetes-1-33-3-containerd-2-1-3   1/1     Running   1 (115s ago)   12m
kube-system   kube-proxy-9prbv                                             1/1     Running   1 (115s ago)   12m
kube-system   kube-scheduler-kubernetes-1-33-3-containerd-2-1-3            1/1     Running   1 (115s ago)   12m
```
...
```shell
make all ENV=kubernetes/v1.33.3/containerd/v2.1.3/init
```
...
FROM ghcr.io/ctrsploit/kubernetes-v1.33.3_containerd-v2.1.3_base:ctr_v0.1.0
...
...
RUN --mount=type=cache,id=kubernetes-v1.33.3_containerd-v2.1.3-snapshots,target=/trick \
    cp -a /var/lib/containerd/io.containerd.snapshotter.v1.overlayfs/* /trick/
# kubeadm init under ext4 fs
RUN --mount=type=cache,id=kubernetes-v1.33.3_containerd-v2.1.3-snapshots,target=/var/lib/containerd/io.containerd.snapshotter.v1.overlayfs \
