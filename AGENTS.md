...
- Repository-local skills live in `.agents/skills/` (Agent Skills open standard):
  - `.agents/skills/dqd-use/SKILL.md` for operating existing environments.
  - `.agents/skills/dqd-dev/SKILL.md` for developing dqd, migrating environments, and changing ports/CI/build logic.
