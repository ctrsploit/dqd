...
<!-- VERIFY -->
root@nvidia-container-toolkit-1-16-1:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/06b4ed347e997062c460bd41160dccbea8bbb996ee3bb7e4c4d367e33bd3f2f7/config.json | jq .hooks
<!-- VERIFY -->
```
...
<!-- VERIFY -->
root@nvidia-container-toolkit-1-16-1:~# cat /run/containerd/io.containerd.runtime.v2.task/moby/f7a878d988dd4afbbff5516c1043cc7311c858504d8baff7ffc719b73cd9612d/config.json | jq .hooks
<!-- VERIFY -->
```
