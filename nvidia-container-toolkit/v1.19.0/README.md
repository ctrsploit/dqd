...
| Type | Image | Notes |
| ---- | ----- | ----- |
| dqd | ghcr.io/ctrsploit/nvidia-container-toolkit-v1.19.0:latest | points to `v0.9.0` |
| dqd | ghcr.io/ctrsploit/nvidia-container-toolkit-v1.19.0:v0.9.0 | bump nvidia-container-toolkit to 1.19.0 |
| ctr | ghcr.io/ctrsploit/nvidia-container-toolkit-v1.19.0:ctr_v0.9.0 | install real nvidia driver without kernel module; install i386 libs; bump fake-nvidia to v0.7.2; nvidia-container-toolkit 1.19.0 |
...
```dockerfile
FROM ghcr.io/ctrsploit/nvidia-container-toolkit-v1.19.0:ctr_v0.9.0
```
