...
<!-- VERIFY -->
root@nvidia-container-toolkit-1-17-0-rc-1:~# docker ps --latest --quiet --no-trunc | xargs -I{} sh -c 'cat /run/containerd/io.containerd.runtime.v2.task/moby/{}/config.json | jq .hooks'
<!-- VERIFY -->
```
