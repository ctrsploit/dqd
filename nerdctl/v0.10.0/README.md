...
| Type | Image | Notes |
| ---- | ----- | ----- |
| dqd | ghcr.io/ctrsploit/nerdctl-v0.10.0:latest | points to `v0.1.0` |
| dqd | ghcr.io/ctrsploit/nerdctl-v0.10.0:v0.1.0 | migrate from docker_archive |
| dqd | ssst0n3/docker_archive:nerdctl-v0.10.0_v0.1.0 | - |
| ctr | ghcr.io/ctrsploit/nerdctl-v0.10.0:ctr_v0.1.0 | - |
| ctr | ssst0n3/docker_archive:ctr_nerdctl-v0.10.0_v0.1.0 | - |
...
```shell
$ dqd up nerdctl/v0.10.0
$ ssh dqd-nerdctl-v0.10.0
```
...
```shell
make all ENV=nerdctl/v0.10.0
```

for developers:

```dockerfile
FROM ghcr.io/ctrsploit/nerdctl-v0.10.0:ctr_v0.1.0
```
