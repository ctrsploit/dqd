...
| Type | Image | Notes |
| ---- | ----- | ----- |
| dqd | ghcr.io/ctrsploit/nerdctl-v0.23.0:latest | points to `v0.1.0` |
| dqd | ghcr.io/ctrsploit/nerdctl-v0.23.0:v0.1.0 | migrate from docker_archive |
| dqd | ssst0n3/docker_archive:nerdctl-v0.23.0_v0.1.0 | - |
| ctr | ghcr.io/ctrsploit/nerdctl-v0.23.0:ctr_v0.1.0 | - |
| ctr | ssst0n3/docker_archive:ctr_nerdctl-v0.23.0_v0.1.0 | - |
...
```shell
$ dqd up nerdctl/v0.23.0
$ ssh dqd-nerdctl-v0.23.0
```
...
go: go1.17.10
libseccomp: 2.5.4
root@nerdctl-0-23-0:~# cat /etc/os-release
...
root@nerdctl-0-23-0:~# uname -a
Linux nerdctl-0-23-0 5.15.0-185-generic #195-Ubuntu SMP Fri Jun 19 17:11:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
```

## build

```shell
make all ENV=nerdctl/v0.23.0
```

for developers:

```dockerfile
FROM ghcr.io/ctrsploit/nerdctl-v0.23.0:ctr_v0.1.0
```
...
time="2026-06-30T12:18:30Z" level=fatal msg="get apparmor_parser version: apparmor_parser resolves to executable in current directory (./apparmor_parser)"
```
